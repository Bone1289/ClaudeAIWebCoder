    ...
    public void getAccountStatement(GetAccountStatementRequest request,
        ...
        try {
            ...
            GetAccountStatementResponse response = GetAccountStatementResponse.newBuilder()
                    ...
                    .setAccount(mapToAccountResponse(statement.getAccount()))
                    .addAllTransactions(statement.getTransactions().stream()
                            .map(this::mapToTransactionDetail)
                            .collect(Collectors.toList()))
                    .setSummary(StatementSummary.newBuilder()
                            .setOpeningBalance(statement.getOpeningBalance().toString())
                            .setClosingBalance(statement.getClosingBalance().toString())
                            .setTotalDeposits(statement.getTotalDeposits().toString())
                            .setTotalWithdrawals(statement.getTotalWithdrawals().toString())
                            .setTransactionCount(statement.getTransactionCount())
                            .build())
                    .build();
    ...
    public void getCategoryReport(GetCategoryReportRequest request,
        ...
        try {
            ...
            GetCategoryReportResponse response = GetCategoryReportResponse.newBuilder()
                    ...
                    .addAllCategories(report.getCategoryBreakdown().stream()
                            .map(categorySpending -> CategorySpending.newBuilder()
                                    .setCategoryId(categorySpending.getCategoryId().toString())
                                    .setCategoryName(categorySpending.getCategoryName())
                                    .setTotalAmount(categorySpending.getTotalAmount().toString())
                                    .setTransactionCount(categorySpending.getTransactionCount())
                                    .setPercentage(categorySpending.getPercentage())
                                    .build())
                            .collect(Collectors.toList()))
                    .build();
